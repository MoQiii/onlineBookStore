...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<c:url value='/JSP/jsps/css/user/pwd.css'/>">
	<script type="text/javascript" src="<c:url value='/jQuery/jquery-3.1.1.min.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/JSP/jsps/js/user/pwd.js'/>"></script>
	...
	<div class="div1">
		...
		<table>
			...
			<tr>
				<td align="right"></td>
				<td>
				  <img id="vCode" src="<c:url value='/verifyCode/verifyCode'/>" border="1"/>
