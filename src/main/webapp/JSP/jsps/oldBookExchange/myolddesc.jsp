...
<html>
  <head>
    ...
    <%--<script src="<c:url value='/JSP/jsps/pager/pager.js'/>"></script>--%>
	<script src="<c:url value='/jQuery/jquery-3.1.1.min.js'/>"></script>
	
	<link rel="stylesheet" type="text/css" href="<c:url value='/JSP/jsps/css/book/desc.css'/>">
	<script src="<c:url value='/JSP/jsps/js/book/desc.js'/>"></script>
  </head>
  ...
  <div>
    ...
    <div class="divBookDesc">
		...
		<table>
			...
			<div class="divForm">
				<form id="form1" action="<c:url value='/OldBook/delete'/>" method="post">
