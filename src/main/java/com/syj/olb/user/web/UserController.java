...
public class UserController {
    ...
    @RequestMapping("/loginToView")
    public String loginToView(){
    ...
    public String regist(HttpServletRequest req, HttpServletResponse resp,User user)
            throws ServletException, IOException {
    ...
    public String updatePassword(HttpServletRequest req, HttpServletResponse resp ,User formUser)
            throws ServletException, IOException {
        /*
         * 1. 封装表单数据到user中
         * 2. 从session中获取uid
