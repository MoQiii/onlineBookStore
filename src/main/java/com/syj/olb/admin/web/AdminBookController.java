...
public class AdminBookController {
     ...
     */
    @RequestMapping("/edit")
    public String edit(HttpServletRequest req, HttpServletResponse resp, Book book,Category category){
        /*
         * 1. 把表单数据封装到Book对象中
         * 2. 封装cid到Category中
         * 3. 把Category赋给Book
   ...
   //     PageBean<Book> pb = bookService.findByCategory(cid, pc);
    ...
    public String findByCombination(HttpServletRequest req, HttpServletResponse resp,Book criteria){
        /*
         * 1. 得到pc：如果页面传递，使用页面的，如果没传，pc=1
         */
        int pc = getPc(req);
